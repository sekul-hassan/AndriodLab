...
const CertificatesPay = ({ route }) => {
    const { fullName, examRoll, registrationRoll, selectedSession, selectedSemester,examYear, tk } = route.params;
    ...
    const fetchClientSecret = async (paymentData) => {
        try {
            const response = await fetch('http://192.168.137.1:5000/api/certificates/addCertificates', {
                method: 'POST',
...
export default CertificatesPay;
